...
export const UpdateTask = ({
  ...
  useEffect(() => setInputUpdate(taskname), []);
  ...
  return (
    <div
      ...
      aria-hidden="true"
      className={`${
        toggleUpdate ? "grid place-items-center" : "hidden"
    ...
    >
      <div className="relative p-4 w-full max-w-md h-full md:h-auto">
        <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
          ...
          <div className="px-6 pb-4 space-y-6 lg:px-8 sm:pb-6 xl:pb-8">
            ...
            <button
              type="submit"
              onClick={() => handleUpdate(inputUpdate, id)}
      ...
      <div className="w-screen h-screen bg-zinc-400/50 absolute -z-10" />
    </div>
  );
};
